...
import { IsOptional, IsEnum, IsString, IsBoolean, IsInt, Min, IsMongoId } from 'class-validator';
...
export class QueryUserDto {
  ...
  @ApiPropertyOptional({ enum: UserRole, example: UserRole.TEACHER, description: 'Filter by role' })
  @IsOptional()
  @IsEnum(UserRole)
  role?: UserRole;

  @ApiPropertyOptional({ example: '507f1f77bcf86cd799439011', description: 'Filter by school ID' })
  @IsOptional()
  @IsMongoId()
  school?: string;
